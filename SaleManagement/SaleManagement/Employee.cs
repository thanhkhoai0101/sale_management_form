    ...
    public partial class Employee : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                bool resultAdd = _Employee.issetEmployeeName(name);
                if (resultAdd == true)
                {
                    BEL.Employee employee = new BEL.Employee(name, addr, userName, pass, phone, email);
                    bool result = _Employee.addEmployee(employee);
                    if (result == true)
                    {
                ...
                {
                    MessageBox.Show("Mã nhân viên tồn tại!", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            string name = txtName.Text;
            BAL_Employee _Employee = new BAL_Employee();
            bool result = _Employee.deleteEmployee(name);
